...
insert into tbl_reg(sno, name, age, location) values (1001, "Arun Kumar", 20, "Madurai");
...
insert into tbl_reg values ("Arun kumar", 20, "Trichy");  -- Incorrect values
insert into tbl_reg values (11, 22, 20, "Trichy");  -- Incorrect datatype values for second column but works
insert into tbl_reg values ("33", 22, 20, "Trichy");  -- Incorrect datatype values for first column but works
insert into tbl_reg values ("hkjhk", 22, 20, "Trichy");  -- Incorrect datatype values for first column but not works
select * from tbl_reg;
